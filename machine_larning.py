...
from define_values import defineTrainingAndTestValues
import pickle
from helpers import getMessageOk, getMessageError
from sklearn.naive_bayes import GaussianNB


def saveBaseTrainingAndTestValues(nameFile, xTraining, xTest, yTraining, yTest):
    try:
        ...
        getMessageError('salvamento de dados de trainamento e teste...')
        return


def applyMachineLarning(nameFile, baseX, baseY, testSize, machineLarningType, saveBaseData, applyFilesTrainingAndTest, predictValues):
    try:
...
def algorithmNaiveBayes(applyFilesTrainingAndTest, baseX, baseY, testSize, saveBaseData, nameFile, predictValues):
    ...
    if(applyFilesTrainingAndTest == True):
        xTraining, xTest, yTraining, yTest = defineTrainingAndTestValues(
